...
CREATE TABLE establecimiento (direccion varchar(100), coordenadas varchar(50), email varchar(40) NOT NULL, nombre varchar(100) NOT NULL, horario varchar(100) NOT NULL);
