...
CREATE TABLE comentario (idcomentario int(10), idpincho int(10) NOT NULL, NOT NULL AUTO_INCREMENT, contenido varchar(255), fecha date, email varchar(40) NOT NULL, PRIMARY KEY (idcomentario));
