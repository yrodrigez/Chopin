...
<div>
	<div class="pincho-view-title"><h1><?= $pincho->getNombrePincho(); ?></h1></div>
	<div class="pincho-view-img"><img src="<?= 'img/pinchos/'.$pincho->getFotoPincho(); ?>"></div>
	<div class="pincho-view-description">
