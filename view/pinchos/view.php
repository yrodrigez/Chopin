...
<div>
	...
	<div class="view-description">
		...
		<table class="table table-striped table-bordered">
			...
			<tr>
				...
				<?php endif ?>
				<?php if($pincho->getAprobadaPincho() == Pincho::NO_APROBADO && $concurso->isStarted()): ?>
					<td><div class="pinchoNoAprobado">No aprobado</div></td>
				<?php endif ?>
				<?php if($pincho->getAprobadaPincho() == Pincho::NO_APROBADO && !$concurso->isStarted()): ?>
	...
	<?php if(isset($_SESSION["type"]) && $_SESSION["type"] == 0 && $pincho->getAprobadaPincho() == 0 && !$concurso->isStarted()): ?>
	...
	<?php endif; ?>
	<?php if(isset($_SESSION["type"]) && $_SESSION["type"] == 0 && $pincho->getAprobadaPincho() == 1 && !$concurso->isStarted()): ?>
		<div class="view-confirm">
